...
from model import SpatialDescriptor, StructuralDescriptor, MeshConvolution
...
class MeshNet(nn.Module):
    ...
    def __init__(self, require_fea=False):
        ...
        self.mesh_conv1 = MeshConvolution('Concat', 64, 131, 256, 256)
        self.mesh_conv2 = MeshConvolution('Concat', 256, 256, 512, 512)
