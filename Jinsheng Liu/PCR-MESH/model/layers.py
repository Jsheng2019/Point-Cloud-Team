...
class MeshConvolution(nn.Module):
    ...
    def __init__(self, flag, spatial_in_channel, structural_in_channel, spatial_out_channel, structural_out_channel):
        ...
        assert flag in ['Concat', 'Max', 'Average']
        self.aggregation_method = flag
